...
export default function ThemesPage() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center p-4 bg-bg">
      <div className="w-full max-w-2xl bg-card-bg rounded-xl shadow-2xl overflow-hidden border border-border max-h-[90vh]">
        <div className="p-4 sm:p-6 overflow-y-auto max-h-[80vh]">
          <div className="mb-6 text-center">
            <h1 className="text-3xl font-bold text-text">Theme Selector</h1>
            <p className="text-text-muted mt-2">
              Hi, you found a hidden page! You can change the theme here :)
            </p>
          </div>
