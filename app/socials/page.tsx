            ...
            <div className="relative bg-black/60 backdrop-blur-2xl rounded-3xl p-10 border border-white/10 shadow-2xl hover:shadow-blue-500/10 transition-all duration-500">
              <div className="flex items-center gap-6 mb-8">
                <div className="relative group/avatar">
                  <div className="relative w-14 h-14 rounded-full border-2 border-white/20 group-hover/avatar:border-white/40 transition-all duration-300 group-hover/avatar:scale-105 overflow-hidden">
                    <Image
                      src="https://avatars.githubusercontent.com/playfairs"
                      alt="playfairs"
                      width={56}
                      height={56}
                      className="w-full h-full object-cover group-hover/avatar:brightness-110 transition-all duration-300"
                    />
                  </div>
                </div>
              ...
              <div className="flex gap-1 mb-8 bg-white/5 rounded-lg p-1 backdrop-blur-sm">
                {tabs.map((tab) => (
                  <button
                    ...
                    className={`flex-1 py-2 px-4 rounded-md text-sm font-light tracking-wide transition-all duration-300 ${
                      activeTab === tab.id
