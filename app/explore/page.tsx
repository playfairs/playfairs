        ...
        <div className="mx-auto max-w-7xl">
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div>
                ...
                <p className="mt-3 max-w-2xl text-sm leading-7 text-white/65">
                  Same content, different atmosphere. Navigate the same data
                  with a fresh visual rhythm.
                </p>
              </div>
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-[280px_minmax(0,1fr)]">
            <aside className="glass-panel p-4 sm:p-5">
              <h2 className="text-[10px] font-semibold uppercase tracking-[0.35em] text-white/45">
                catalog
              </h2>
                  ...
                  {activeSection === "techstack" && (
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        {techData &&
                          techData[
                            activeSubSection as keyof TechStackData
                          ]?.map((item: TechItem, index: number) => (
                            <div
                              key={index}
                              ...
                              <div className="flex items-center gap-4">
                                ...
                                <div className="min-w-0 flex-1">
                                  <div className="flex items-center gap-2">
                                    ...
                                    {activeSubSection === "languages" &&
                                      languageCounts[item.name] !==
                                        undefined && (
