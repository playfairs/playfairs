            ...
            <div className="relative bg-black/60 backdrop-blur-2xl rounded-3xl p-8 md:p-10 border border-white/10 shadow-2xl hover:shadow-blue-500/10 transition-all duration-500">
              <div className="flex items-center gap-6 mb-10">
                <div className="relative group/avatar">
                  <div className="relative w-16 h-16 rounded-full border-2 border-white/20 group-hover/avatar:border-white/40 transition-all duration-300 group-hover/avatar:scale-105 overflow-hidden">
                    <Image
